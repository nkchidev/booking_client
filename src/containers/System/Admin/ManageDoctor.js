...
class ManageDoctor extends Component {
    ...
    handleChangeSelect = async (selectedOption) => {
        ...
        if (res && res.errCode === 0 && res.data && res.data.Markdown){
            ...
            let addressClinic = '', nameClinic = '', note = '', paymentId = '', specialtyId = '', priceId = '', provinceId = '', clinicId = '',
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if(prevProps.language !== this.props.language) {
            ...
            let dataSelectPrice = this.buildDataInputSelect(resPayment, 'PRICE');
            let dataSelectPayment = this.buildDataInputSelect(resPrice, 'PAYMENT');
